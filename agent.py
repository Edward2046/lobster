...
from tools import get_current_time, calculate, get_weather, get_investing_news, get_earnings_calendar, get_food_trends
...
MODEL_ID = "deepseek/deepseek-chat"  # deepseek-chat = DeepSeek-V3，速度快、能力强
